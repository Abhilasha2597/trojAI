...
class CSVDataset(DatasetInterface):
    ...
    def __init__(self, path_to_data: str, csv_filename: str, true_label=False, path_to_csv=None, shuffle=False,
        ...
        :param path_to_csv: If not None, specifies the fsolder where the CSV file lives.  If None, it is assumed that
...
class CSVTextDataset(torchtext.legacy.data.Dataset, DatasetInterface):
    """
