...
def modify_clean_image_dataset(clean_dataset_rootdir: str, clean_csv_file: str,
    ...
    :param output_subdir: subdirectory where the modified data will be stored.  This is expected to be one level
                          ...
                          stored in different subdirectories under the main root directory.
    ...
    :param random_state_obj: RandomState object to ensure reproducibility of the dataset
    :return: None
    """
    ...
    # Read in the clean dataset from a CSV file
    ...
    # Reset random state to ensure reproducibility regardless of the number of splits
    random_state_obj.set_state(random_state)

    # Generate the same number of triggers according to the configuration
